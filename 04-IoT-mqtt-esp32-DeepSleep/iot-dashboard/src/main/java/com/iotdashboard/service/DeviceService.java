...
public class DeviceService {
    ...
    public void updateDeviceField(String macAddress, String field, String value) {
        ...
        switch (field) {
            ...
            case "boot_count" -> device.setBootCount(parseLong(value));
            case "sleep_interval" -> device.setSleepInterval(parseInt(value));
            // Ignore config/interval — that's our own retained message echoed back
        }
